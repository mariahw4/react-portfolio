...
<>
    <div className= "container py-4">
       ...
       <div className="card col">
                ...
                <img className="card-img-top" src="/images/tech-blog.png" alt="screenshot of webpage"/>
       ...
       <div className="row">
            <div className="card col">
                ...
                <img className="card-img-top" src="/images/webAPI.png" alt="screenshot of webpage"/>
                <div className="card-body">
                    <p className="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
            ...
            <div className="card col">
                ...
                <img className="card-img-top" src="/images/workday-scheduler.png" alt="screenshot of webpage"/>
                <div className="card-body">
                    <p className="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
        ...
        <div className="row">
            <div className="card col">
                ...
                <img className="card-img-top" src="/images/weather-dashboard.png" alt="screenshot of webpage"/>
                <div className="card-body">
                    <p className="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
            ...
            <div className="card col">
                ...
                <img className="card-img-top" src="/images/password-generator.png" alt="screenshot of webpage"/>
                <div className="card-body">
                    <p className="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
            ...
            <div className="card col">
                ...
                <img className="card-img-top" src="/images/early-portfolio.png" alt="screenshot of webpage"/>
                <div className="card-body">
                    <p className="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
